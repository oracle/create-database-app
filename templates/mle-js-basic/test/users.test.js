...
describe('user_package', () => {
  ...
  it('should update a user by ID', async () => {
    const plsql = `BEGIN USER_PACKAGE.UPDATEUSER(:id, :name); END;`;
    const binds = { id: createdUserId, name: 'Jane Doe' };

    await executeSQLScriptWithOutput(plsql, binds);
    console.log('User updated');
  });

  it('should delete a user by ID', async () => {
    const plsql = `BEGIN USER_PACKAGE.DELETEUSER(:id); END;`;
